...
offboard_pub = ros2publisher(ros2node, "/px4_1/fmu/in/offboard_control_mode", "px4_msgs/OffboardControlMode");
traj_pub     = ros2publisher(ros2node, "/px4_1/fmu/in/trajectory_setpoint", "px4_msgs/TrajectorySetpoint");
vehicle_pub  = ros2publisher(ros2node, "/px4_1/fmu/in/vehicle_command", "px4_msgs/VehicleCommand");
...
while true
    ...
    traj_msg.position     = single([-10.0, -5.0, -3.0]);  % z = -5 meters
