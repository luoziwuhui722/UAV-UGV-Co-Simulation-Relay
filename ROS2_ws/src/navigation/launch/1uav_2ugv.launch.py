...
def generate_launch_description():
    ...
    # 定义机器人名称和初始位置
    robots = [
        {'name': 'TB3_1', 'x_pose': '-20.0', 'y_pose': '6.0', 'z_pose': 0.01},
        {'name': 'TB3_2', 'x_pose': '10.0', 'y_pose': '5.0', 'z_pose': 0.01},
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('navigation'), 'maps', 'Factory.yaml'),
                     },],
    ...
    timer_action = TimerAction(period=10.0, actions=delayed_actions)
