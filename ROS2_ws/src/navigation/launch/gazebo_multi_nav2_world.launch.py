...
def generate_launch_description():
    ...
    for robot in robots:
        ...
        # 定义机器人的命名空间
        namespace = '/' + robot['name']   # 字符串，如 '/TB3_1'
        ...
        # 如果是第一个机器人，直接添加到LaunchDescription
        if last_action is None:
            # 直接添加第一个机器人的节点，便于后续通过RegisterEventHandler进行链式实例化
            ...
            # 直接调用ld.add_action会导致spawn_entity并行运行，可能引起问题
